...
.LM39:
	...
	leaq	.LC3(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,42,.LM40-.LFBB2
.LM40:
	leaq	4(%rsp), %rdx
	movl	$57616, %esi
	xorl	%eax, %eax
	leaq	.LC4(%rip), %rdi
	.stabn	68,0,41,.LM41-.LFBB2
.LM41:
	movl	$6581362, 4(%rsp)
	.stabn	68,0,42,.LM42-.LFBB2
.LM42:
	call	cprintf@PLT
	.stabn	68,0,44,.LM43-.LFBB2
.LM43:
	leaq	.LC5(%rip), %rdi
	movl	$3, %esi
	xorl	%eax, %eax
	call	cprintf@PLT
	.stabn	68,0,46,.LM44-.LFBB2
.LM44:
	movl	$5, %edi
	call	test_backtrace
	.p2align 4,,10
...
# 74 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,76,.LM52-.LFBB3
.LM52:
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,77,.LM53-.LFBB3
.LM53:
	movl	%esi, %edx
	movq	%rdi, %rsi
	.stabn	68,0,76,.LM54-.LFBB3
.LM54:
	movl	$24, (%rsp)
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
...
.LM55:
	leaq	.LC6(%rip), %rdi
	.stabn	68,0,76,.LM56-.LFBB3
.LM56:
	movq	%rax, 16(%rsp)
	.stabn	68,0,77,.LM57-.LFBB3
.LM57:
	xorl	%eax, %eax
	.stabn	68,0,76,.LM58-.LFBB3
.LM58:
	movl	$48, 4(%rsp)
	.stabn	68,0,77,.LM59-.LFBB3
.LM59:
	call	cprintf@PLT
	.stabn	68,0,78,.LM60-.LFBB3
.LM60:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,79,.LM61-.LFBB3
.LM61:
	leaq	.LC7(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LM69:
	xorl	%eax, %eax
	.stabn	68,0,94,.LM70-.LFBB4
.LM70:
	movl	$24, (%rsp)
	movl	$48, 4(%rsp)
	.stabn	68,0,95,.LM71-.LFBB4
.LM71:
	call	cprintf@PLT
	.stabn	68,0,96,.LM72-.LFBB4
.LM72:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,97,.LM73-.LFBB4
.LM73:
	xorl	%eax, %eax
	leaq	.LC7(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,99,.LM74-.LFBB4
.LM74:
	movq	24(%rsp), %rax
	subq	%fs:40, %rax
	jne	.L29
