...
i386_detect_memory(void)
{
	...
	cprintf("Physical memory: %uK available, base = %uK, extended = %uK, NO of pages is %d\n",
...
{
	static char *nextfree;	// virtual address of next byte of free memoryf
	char *result;
...
mem_init(void)
{
    ...
    cprintf("The remaining physical memory is %x", boot_alloc(0));
	//////////////////////////////////////////////////////////////////////
...
boot_map_region(pde_t *pgdir, uintptr_t va, size_t size, physaddr_t pa, int perm)
{
    ...
    for (i = 0; i < size/PGSIZE; i++) {
        if ((pte = pgdir_walk(pgdir, (const void*)va, true)) == NULL) {
